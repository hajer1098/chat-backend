...
class MyInbox(generics.ListAPIView):
    ...
    def get_queryset(self):
        #extracting the user_id from the URL's keyword arguments (self.kwargs)
        user_id=self.kwargs['user_id']
            ...
            id__in=Subquery(
                User.objects.filter(
                  ...
                  Q(receiver__sender=user_id)
                    ...
                    #values_list :extracts the ID of the latest message for each user
